...
<div class='authform' style='text-align: right'>
        <h3 style='text-align: center'>Добавление контрагента</h3>
        <form action="save_user.php" method="post">
        <!--**** save_user.php - это адрес обработчика.  ***** -->
        <p>
        <label>Наименование:</label>
        <input name="Name" type="text" required maxlength="100" style='width:80%'>
        </p>
        <!--**** В текстовое поле пользователь вводит  ***** -->
        <p>
        <label>ИНН:         </label>
        <input name="INN" type="text" required style='width:80%' maxlength="100">
        </p>
         <!--**** В поле  пользователь вводит  ***** --> 
         <p>
        <label>КПП:         </label>
        <input name="KPP" type="text"  style='width:80%' maxlength="100">
        </p>
         <!--**** В поле  пользователь вводит  ***** --> 
          <p>
        <label>Индекс:</label>
        <input name="Index" type="text"  style='width:80%' maxlength="100">
        </p>
         <!--**** В поле  пользователь вводит  ***** --> 
          <p>
        <label>Регион:</label>
        <input name="Region" type="text"  style='width:80%' maxlength="100">
        </p>
         <!--**** В поле  пользователь вводит  ***** --> 
          <p>
        <label>Город:</label>
        <input name="City" type="text"  style='width:80%' maxlength="100">
        </p>
         <!--**** В поле  пользователь вводит  ***** --> 
          <p>
        <label>Улица:</label>
        <input name="Street" type="text"  style='width:80%' maxlength="100">
        </p>
         <!--**** В поле  пользователь вводит  ***** --> 
          <p>
        <label>Дом:</label>
        <input name="House" type="text"  style='width:80%' maxlength="100">
        </p>
         <!--**** В поле  пользователь вводит  ***** --> 
        <p>
